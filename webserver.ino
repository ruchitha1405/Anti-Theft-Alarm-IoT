...
ptr +="</script>\n";
  ...
  ptr +="<div class=\"box\">\n";
  ptr +="<button class=\"slidebtn\"><img src=\"https://png.pngtree.com/element_our/20200702/ourlarge/pngtree-cartoon-illustration-blue-light-bulb-image_2284830.jpg\" style=\"width: 150px; height:150px; border-radius: 100%; object-fit: cover;\"></button>\n";
  ptr +="<div class=\"hide\">\n";
  ptr +=led_status;
  ptr += "</div>\n";
  ptr += "</div>\n";
